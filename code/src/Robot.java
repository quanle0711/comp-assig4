...
public class Robot {
	...
	public Robot(World world, int x, int y, String colour, boolean noWait) {
		...
		targetFuel = fuel;
		try {
			robotImage1 = ImageIO.read(new File("code/assets/robot_" + colour + "_1.png"));
			robotImage2 = ImageIO.read(new File("code/assets/robot_" + colour + "_2.png"));
			shieldImage = ImageIO.read(new File("code/assets/shield.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
